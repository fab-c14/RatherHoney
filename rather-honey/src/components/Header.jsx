...
const Header = () => {
  ...
  return (
    <header className="header fixed top-0 left-0 right-0 z-50 bg-white shadow-lg py-4 px-6 flex items-center justify-between">
      {/* Logo Section */}
      ...
      <nav
        className={`${
          navbarActive ? "right-0" : "-right-full"
        } fixed top-0 right-0 w-[70%] bg-white transition-all duration-300 ease-in-out lg:block lg:static lg:w-auto`}
      >
        <ul className="flex flex-col lg:flex-row lg:justify-center gap-4 p-4">
          <li>
            <a href="#home" className="text-lg text-gray-900 hover:text-orange-500">
              Home
            </a>
          </li>
          <li>
            <a href="#features" className="text-lg text-gray-900 hover:text-orange-500">
              Features
            </a>
          </li>
          <li>
            <a href="#products" className="text-lg text-gray-900 hover:text-orange-500">
              Products
            </a>
          </li>
          <li>
            <a href="#categories" className="text-lg text-gray-900 hover:text-orange-500">
              Categories
            </a>
          </li>
          <li>
            <a href="#review" className="text-lg text-gray-900 hover:text-orange-500">
              Review
            </a>
          </li>
          <li>
            <a href="#blogs" className="text-lg text-gray-900 hover:text-orange-500">
              Blogs
            </a>
          </li>
        </ul>
      ...
      <div className="icons flex items-center gap-6">
        <div onClick={toggleNavbar} className="text-xl cursor-pointer lg:hidden">
          <FaBars />
        </div>
